...
sleep 1
ros2 topic pub -r 10 -t 100 /cmd_vel_nav geometry_msgs/msg/Twist "{linear: {x: 0.0, y: 0.0, z: 0.0}, angular: {x: 0.0, y: 0.0, z: 0.3}}" --qos-reliability reliable --qos-durability volatile
